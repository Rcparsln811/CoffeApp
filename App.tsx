...
import { categories, coffeeItems } from '../COFFEAPP/constants';
...
const App = () => {
  ...
  return (
    <View style={styles.container}>
      <StatusBar />
      <Image style={styles.beansbg} source={require('../COFFEAPP/assets/images/beansBackground1.png')}
      />
      <SafeAreaView style={{ flex: 1 }}>
        {/* Avatar ve Bildirim İkonu*/}
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
          <Image style={styles.avatar} source={require('../COFFEAPP/assets/images/avatar.png')} />
          <View style={{ flexDirection: 'row', alignItems: 'center',}}>
            <Image style={{ width: 30, height: 40, tintColor: '#B87A40' }} source={require('../COFFEAPP/assets/images/pin.png')} />
            <Text style={{ fontWeight: '600', fontSize: 16, }}>Istanbul,Turkiye</Text>
          </View>
          <Image style={{ width: 30, height: 30, marginRight: 10, }} source={require('../COFFEAPP/assets/images/bell.png')} />
        </View>
        {/* Arama Barı */}
        <View style={[styles.container2, { marginTop: 85, }]}>
          <View style={styles.searchBar}>
            ...
            <TouchableOpacity style={[styles.button, { backgroundColor: '#B87A40' }]}>
              <Image style={{ width: 15, height: 15, tintColor: 'white', }} source={require('../COFFEAPP/assets/images/search.png')} />
            </TouchableOpacity>
          </View>
        </View>
        {/* Katagoriler */}
